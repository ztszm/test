...
* 规划用途（只读）
*/
public interface PlanningUse extends  Attribute {
	...
	class object extends  SuperBean  implements PlanningUse{
		...
		public static void copy(PlanningUse bean, PlanningUse from){
