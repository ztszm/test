...
* 报修来源
*/
public interface RepairSource extends  Attribute {
	...
	class object extends  SuperBean  implements RepairSource{
		...
		public static void copy(RepairSource bean, RepairSource from){
